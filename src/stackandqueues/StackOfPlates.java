 ...
 * Implement a data structure SetOfStacks that mimics this. SetOfStacks should be composed of severals stacks
 * and should create a new stack once the previous one exceeds capacity.
 * SetOfStacks.push and SetOfStacks.pop() should behave identically to a single stack (that is, pop() should return
 * the same values as it would if there were just a single stack). Also implement a function popAt(index)
